...
import {Button,Skeleton,PhotoField,TextareaField, Group, TextField, Field, Toast } from 'saltui';
                  ...
                  "department":{
                    ...
                    "list":[statebasicJSON],
                     ...
                     "reqType":1,//1--红包/加息券 2--现金奖励
                      "rewardType":1, //1-红包 3--加息券 5--现金奖励
                      "rewardTypeName":"红包", //1-红包 3--加息券 5--现金奖励
                      "applyName":"101",//申请人
                      "singledata":{
                      "userPhone":{
                          default:"",
...
//this.dispatch('getActivityId',this.state.ajaxdata);
  ...
  render() {
    ...
    if(t.state.ajaxdata.rewardType==3){
    ...
    return (
            <div className="container">          
                {t.state.isrender ? (
                      ...
                      <div className="t-LH44 t-BCd t-FAC t-MT16" onClick={()=>t.addOneItem()}  style={{color:'#09c'}}>{t.state.ajaxdata.rewardType==3 ?"增加加息券":"增加红包"}+</div>
                      ):null}
